...
data.deploy_types.each do |deploy_type, deploy_name|
  ...
  proxy "/download/beta/#{deploy_type}.html", "/download/index.html", locals: {deploy_type: deploy_type, deploy_name: deploy_name, build_type: "beta"}
end
proxy "/download/devel.html", "/download/index.html", locals: {build_type: "devel"}
proxy "/download/beta.html", "/download/index.html", locals: {build_type: "beta"}
